...
import { customersRouter, heroesRouter } from '../modules/heroes/heroes.routes';
import { heroOpsRouter } from '../modules/hero-ops/hero-ops.routes';
import { paymentRouter } from '../modules/payments/payment.routes';
import { settingsRouter } from '../modules/settings/settings.routes';
import { capacityRouter } from '../modules/capacity/capacity.routes';
...
apiRouter.use('/hero/me', heroOpsRouter);
